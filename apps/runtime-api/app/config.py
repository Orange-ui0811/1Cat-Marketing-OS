...
class Settings(BaseSettings):
    ...
    hermes_model_provider: str = "deepseek"
    hermes_model_id: str = "deepseek-v4-pro"
    model_mode: str = "deepseek-api-key"
    model_gateway_url: str = "http://model-gateway:8010"
    model_gateway_client_token: str = ""
    model_api_key_file: str = "/runtime-secrets/model_api_key"
    model_runtime_state_file: str = "/runtime-control/model-runtime.json"
